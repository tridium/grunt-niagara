...
module.exports = function (grunt) {
  var niagaraHome = grunt.option('niagara-home') || process.env.NIAGARA_HOME,
      niagaraConfigHome = grunt.option('niagara-config-home') || process.env.NIAGARA_CONFIG_HOME,
  ...
  return {
    ...
    /** NIAGARA_CONFIG_HOME environment variable */
    'niagara-config-home': niagaraConfigHome && path.normalize(niagaraConfigHome),
    ...
    'chrome-flags': '--window-size=1920,1080',
